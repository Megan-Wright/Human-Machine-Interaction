...
\begin{mdframed}
i) We tried a method in the ev3dev documentation called run_timed, which can rotate the wheel by calculating time and speed, however it didn't work in the way we needed for this question.
